...
<!-- /#our-services -->
<section id="questions-and-testimonials" class="section colored-wrapper">
<div class="container">
    <div class="row">
        <div class="col-md-6 wrapper-1">
            <h5 class="subpage-title">Why Choose Us?</h5>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            Eius vulputate at vis. Malorum praesent dissentiunt mei ad. Copiosae dissentiunt cu per. Error impetus argumentum cu sed, ex appareat delicata gubergren pro, at ius erat dissentias. Tacimates interpretaris sit ex.
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
        ...
        <div class="col-md-6  wrapper-1">
            ...
            <div id="caroufredsel-testimonials-container">
                ...
                <div class="testimonial">
                    ...
                    <div class="testimonial-author">
                        <img src="assets/img/users/photo (2).jpg" alt="User Image">
                        <span class="user">Bushra Karim</span>
                        <span class="user-info">Art Director At MYCOMPANYY</span>
                    </div>
                </div>
                <div class="testimonial">
                    <div class="testimonial-content">
                    ...
                    <div class="testimonial-author">
                        <img src="assets/img/users/photo (3).jpg" alt="User Image">
                        <span class="user">Shubro Dev Mondal</span>
                        <span class="user-info">Web Developer At MYCOMPANYY</span>
                    </div>
                </div>
            </div>
        </div>
